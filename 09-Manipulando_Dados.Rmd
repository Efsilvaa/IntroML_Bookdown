...
not_cancelled %>% 
  ...
  summarise(
    ...
    avg_delay2 = mean(arr_delay[arr_delay > 0]) # Considere somente os atrasos (positivos)
  )
...
O RStudio[RStudio](www.rstudio.com) disponibiliza uma folha de resumo para pacotes **Dplyr** e **Tidyr** ([Data Wrangling Cheatsheet - RStudio](https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf)). 
